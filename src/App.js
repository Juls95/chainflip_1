...
// Configuración del SwapSDK
/*const swapSDK = new SwapSDK({
  network: ChainflipNetwork.TESTNET,
  backendServiceUrl: 'https://example.chainflip.io',
  signer: null, // Aquí debes pasar el signer adecuado, por ejemplo, un signer de ethers.js
  broker: {
    url: 'https://my.broker.io',
    commissionBps: 0, // Puntos básicos de la comisión, por ejemplo, 100 = 1%
  },
}); 

esto ba abajo en el return

   <div className="App">
        <TransactionForm />
        <TransactionList />
        <SwapForm swapSDK={swapSDK} />  {/* Pasa el swapSDK como prop a SwapForm }
        </div> */
